    ...
    #define TOKEN "BBUS-8YLxkwftUju1ERhH1aoxUneHDta7kZ" // Ubidots TOKEN name el mismo que usamos en clase 
    #define MQTT_CLIENT_NAME "1429183MbRle" //ID del cliente, 8 a 12 chars alfanumericos (ASCII), debe ser random y unico dif a otros devices 
    #define VARIABLE_LABEL_temp "temperatura" // Variable Temperatura 
    #define VARIABLE_LABEL_hum "humedad" // Variable Humedad 
    #define DEVICE_LABEL "mqtt-publish-esp32-mar" // Nombre del dispositivo a crear 
