...
public class MainActivity extends Activity {
    ...
    public class ApiUbidots extends AsyncTask<Integer, ProgressUpdate, Void> {
        private final String API_KEY_UBIDOTS = "BBUS-8YLxkwftUju1ERhH1aoxUneHDta7kZ";
        private final String TempVariable_ID = "67217ee1fb32f60fe1675e5c";
        private final String HumVariable_ID = "67217ee1fb32f60fe1675e5d";
