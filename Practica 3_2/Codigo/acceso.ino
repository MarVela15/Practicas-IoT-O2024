// Práctica hecha por Marlem Vela - clase IoT
// El objetivo de esta practica es leer el UID de las tarjetas presentadas y determinar si el acceso debe ser concedido o
//denegado. A través de la interacción con LEDs y mensajes en el monitor serial, se simulará un sistema de
//seguridad básico que permite gestionar el acceso a un área restringida.
...
byte Usuario1[4] = {0x76, 0xF4, 0x47, 0x32}; // UID tarjeta CON acceso (reemplaza por tu UID) ITESO
byte Usuario2[4] = {0xC3, 0xD6, 0x55, 0xFC}; // UID de otra tarjeta que quieras que tenga acceso BLANCA
